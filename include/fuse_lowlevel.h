 ...
 * will be removed from *args*. Unknown arguments will be ignored and
 * left untouched. Note that when passed ``--help`` or ``-V``, this
 * function will print to stderr and terminate the program.
 *
